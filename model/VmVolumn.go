...
type VmVolume struct {
	...
	RootImageUUID      string `json:"rootImageUuid" bson:"rootImageUuid"`           //根云盘镜像UUID
	Size               int64  `json:"size" bson:"size"`                             //云盘虚拟容量
	State              string `json:"state" bson:"state"`                           //云盘的可用状态
	Status             string `json:"status" bson:"status"`                         //云盘的连接状态
	Type               string `json:"type" bson:"type"`                             //云盘类型
	UUID               string `json:"uuid" bson:"uuid"`                             //资源的UUID，唯一标示该资源
	VMInstanceUUID     string `json:"vmInstanceUuid" bson:"vmInstanceUuid"`         //云主机UUID
	IsShareable        bool   `json:"isShareable" bson:"isShareable"`               //云盘是否共享
	VolumeQos          string `json:"volumeQos" bson:"volumeQos"`                   //云盘Qos，格式如total=1048576
}
...
type RevertVolumeFromSnapshotRequest struct {
	ReqConfig
	Uuid                     string                 `json:"uuid" bson:"uuid"`                                                             //云盘UUID
	RevertVolumeFromSnapshot map[string]interface{} `json:"revertVolumeFromSnapshot,omitempty" bson:"revertVolumeFromSnapshot,omitempty"` //放空
	SystemTags               []string               `json:"systemTags,omitempty" bson:"systemTags,omitempty"`                             //云主机系统标签
	UserTags                 []string               `json:"userTags,omitempty" bson:"userTags,omitempty"`                                 //云主机用户标签
}
...
type GetVolumeSnapshotSizeRequest struct {
	ReqConfig
	Uuid                  string                 `json:"uuid" bson:"uuid"`                                                       //云盘UUID
	GetVolumeSnapshotSize map[string]interface{} `json:"getVolumeSnapshotSize,omitempty" bson:"getVolumeSnapshotSize,omitempty"` //放空
	SystemTags            []string               `json:"systemTags,omitempty" bson:"systemTags,omitempty"`                       //云主机系统标签
	UserTags              []string               `json:"userTags,omitempty" bson:"userTags,omitempty"`                           //云主机用户标签
}
...
type ShrinkVolumeSnapshotRequest struct {
	ReqConfig
	Uuid                 string                 `json:"uuid" bson:"uuid"`                                                     //云盘UUID
	ShrinkVolumeSnapshot map[string]interface{} `json:"shrinkVolumeSnapshot,omitempty" bson:"shrinkVolumeSnapshot,omitempty"` //空
	SystemTags           []string               `json:"systemTags,omitempty" bson:"systemTags,omitempty"`                     //云主机系统标签
	UserTags             []string               `json:"userTags,omitempty" bson:"userTags,omitempty"`                         //云主机用户标签
}
